/*** Autogenerated by WIDL 1.5.12 from exdisp.idl - Do not edit ***/
...
static FORCEINLINE HRESULT IWebBrowserApp_get_HWND(IWebBrowserApp* This,LONG *pHWND) {
...
static FORCEINLINE HRESULT IWebBrowser2_get_HWND(IWebBrowser2* This,LONG *pHWND) {
    return This->lpVtbl->get_HWND(This,pHWND);
}
