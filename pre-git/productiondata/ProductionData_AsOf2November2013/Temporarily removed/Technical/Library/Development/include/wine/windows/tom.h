/*** Autogenerated by WIDL 1.5.12 from tom.idl - Do not edit ***/
...
static FORCEINLINE HRESULT ITextFont_GetKerning(ITextFont* This,LONG *pValue) {
    return This->lpVtbl->GetKerning(This,pValue);
}
static FORCEINLINE HRESULT ITextFont_SetKerning(ITextFont* This,LONG Value) {
...
static FORCEINLINE HRESULT ITextFont_GetPosition(ITextFont* This,LONG *pValue) {
    return This->lpVtbl->GetPosition(This,pValue);
}
static FORCEINLINE HRESULT ITextFont_SetPosition(ITextFont* This,LONG Value) {
...
static FORCEINLINE HRESULT ITextFont_GetSize(ITextFont* This,LONG *pValue) {
    return This->lpVtbl->GetSize(This,pValue);
}
static FORCEINLINE HRESULT ITextFont_SetSize(ITextFont* This,LONG Value) {
...
static FORCEINLINE HRESULT ITextPara_GetListTab(ITextPara* This,LONG *pValue) {
    return This->lpVtbl->GetListTab(This,pValue);
}
static FORCEINLINE HRESULT ITextPara_SetListTab(ITextPara* This,LONG Value) {
...
static FORCEINLINE HRESULT ITextPara_GetWindowControl(ITextPara* This,float *pValue) {
    return This->lpVtbl->GetWindowControl(This,pValue);
}
static FORCEINLINE HRESULT ITextPara_SetWindowControl(ITextPara* This,float Value) {
    return This->lpVtbl->SetWindowControl(This,Value);
}
