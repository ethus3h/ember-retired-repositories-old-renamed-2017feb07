...
QT += webkit
#QMAKE_CXXFLAGS += -DRESLIST_TEXTBROWSER -DSNIPPETS_TEXTBROWSER
...
unix {
  ...
  !macx {
    LIBS += -Wl,-rpath=${exec_prefix}/lib/recoll
  }

  LIBS +=   -lxapian -lz $(LIBXAPIANSTATICEXTRA) \
       -L${exec_prefix}/lib $(BDYNAMIC)  -lz
