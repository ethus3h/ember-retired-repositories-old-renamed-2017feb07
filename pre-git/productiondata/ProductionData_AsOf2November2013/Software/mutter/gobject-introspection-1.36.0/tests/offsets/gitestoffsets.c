...
compiled_OffsetsBasic (FILE *outfile)
{
  ...
  fprintf (outfile, "%s %ld\n", "dummy9", G_STRUCT_OFFSET(OffsetsBasic, dummy9));
  fprintf (outfile, "%s %ld\n", "field_time", G_STRUCT_OFFSET(OffsetsBasic, field_time));
...
introspected_OffsetsBasic (FILE *outfile)
{
  ...
  print_field_offset(outfile, struct_info, "dummy9");
  print_field_offset(outfile, struct_info, "field_time");
