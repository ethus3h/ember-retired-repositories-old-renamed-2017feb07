...
open(OUTPUT, ">>links.scdat") or print "Output error (links.scdat): $!"."!\n";
...
my $url = "url";
my $test = "Test of *(#R*n <html> this, but given<a href=\"meta.html\" the amount of <em>TIme</EM>";
my $data = "$test";
my $links = "$data";
#extract links
$extor->parse_file($links);
#nls to spaces
$test =~ s/\n/ /g;
